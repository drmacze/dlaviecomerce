        ...
        <HeroReveal>
          <div className="dlv-hero-card" data-motion="parallax" data-speed="0.12">
            <div className="dlv-hero-copy">
              ...
              <p className="dlv-copy" data-motion="reveal" data-delay="0.35">
                Dlavie builds commerce, AI, and automation products for the next generation of digital life.
              </p>
              <div className="dlv-actions" aria-label="Hero calls to action" data-motion="reveal" data-delay="0.48">
            ...
            <div className="dlv-hero-visual" aria-label="Dlavie Cubic Core brand visual" data-motion="reveal" data-delay="0.22">
              <DlavieThreeStage />
              <SideRail />
