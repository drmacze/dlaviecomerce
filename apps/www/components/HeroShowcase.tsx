...
export function HeroShowcase() {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      gsap.set(".dlv-cinematic-frame", { scale: 0.72, borderRadius: "2rem" });
      gsap.set(
        ".dlv-cinematic-copy, .dlv-cinematic-footer, .dlv-cinematic-kicker",
      ...
      gsap
        .timeline({
          ...
          scrollTrigger: {
            ...
            onUpdate: (self) => {
              ...
              document.documentElement.style.setProperty(
                "--dlv-active-section",
                Math.min(Math.floor(self.progress * 6), 5).toString(),
              );
            },
          },
        })
        ...
        .to(
          ".dlv-cinematic-kicker, .dlv-cinematic-copy",
          {
            autoAlpha: 1,
            y: 0,
            filter: "blur(0px)",
        ...
        .to(
          ".dlv-cinematic-frame",
          { scale: 1, borderRadius: "1.25rem", duration: 0.82 },
          6.92,
        )
        .to(
          ".dlv-cinematic-footer",
          { autoAlpha: 1, y: 0, filter: "blur(0px)", duration: 0.38 },
          7.52,
        )
        .to(
          ".dlv-cloud-cinematic",
        ...
        .set(
          ".dlv-cloud-hero-main, .dlv-cloud-giant-word, .dlv-cloud-word-row, .dlv-cloud-logo-row, .dlv-cloud-beat-one, .dlv-cloud-beat-two, .dlv-cloud-beat-three, .dlv-cloud-preview, .dlv-cloud-cinematic",
          { autoAlpha: 0 },
          8.48,
        )
        .to(
    ...
    <main ref={root} className="dlv-cloud-page">
      <div className="dlv-cloud-stage">
        ...
        >
          ...
          <h2>Build from the DLavie ecosystem.</h2>
          <p>Choose the product surface you want to explore first.</p>
