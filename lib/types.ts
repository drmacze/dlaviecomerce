...
export type Product = { id: string; name: string; slug: string; description: string | null; price: number; category: string; image_url: string | null; file_path: string | null; is_published: boolean; created_at: string };
...
export type LPointLedger = { id: string; user_id: string; amount: number; reason: string; created_at: string };
