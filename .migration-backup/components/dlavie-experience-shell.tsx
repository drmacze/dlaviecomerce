...
export function DlavieExperienceShell({ children }: { children: ReactNode }) {
  useEffect(() => {
    document.documentElement.dataset.dlavieEngine = 'experience-2';
  }, []);

  return (
    <MotionConfig reducedMotion="user" transition={{ duration: dlavieExperience.motion.normal, ease: dlavieExperience.motion.easing }}>
      <DlaviePageProgress />
