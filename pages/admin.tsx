...
export default function Admin() {
  ...
  async function save(event: FormEvent) {
    ...
    const { error } = await supabase.from('products').insert({ name, slug, description, price: Number(price || 0), category, image_url: imageUrl || null, file_path: filePath || null, is_published: published });
