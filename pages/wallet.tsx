...
export default function WalletPage() {
  ...
  async function manualTopup(proof: ManualProof) {
    ...
    setStatus(`Request topup terkirim. Ref ${json.transaction?.reference || '-'} menunggu review admin.`);
  }
